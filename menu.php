...
<div style="max-width: 1200px; margin: 30px auto; padding: 0 20px; font-family: 'Segoe UI', sans-serif;">
    ...
    <!-- ========================================== -->
    <!-- PANEL REKAPITULASI (HANYA BISA DIAKSES OLEH ADMIN) -->
    <!-- ========================================== -->
    <?php if ($_SESSION['role'] === 'admin'): ?>
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(260px, 1fr)); gap: 20px;">
            ...
            <!-- REKAP 2: IZIN PULANG (KUNING/ORANGE) -->
            <div style="background: white; padding: 20px; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.04); display: flex; flex-direction: column; justify-content: space-between; border-top: 4px solid #f97316;">
                ...
                <p style="color: #64748b; font-size: 0.85rem; line-height: 1.5; margin-bottom: 15px;">Memantau arsip histori laporan, tanggal, dan nama siswa yang mengajukan izin pulang darurat.</p>
            ...
            <div style="background: white; padding: 20px; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.04); display: flex; flex-direction: column; justify-content: space-between; border-top: 4px solid #4f46e5;">
                ...
                <a href="rekap_iguru.php" style="display: block; text-align: center; padding: 10px; text-decoration: none; border-radius: 6px; font-size: 0.9rem; font-weight: bold; color: white; background: #4f46e5;">Buka Rekap Izin Guru</a>
            </div>

        </div>

        <!-- ========================================== -->
        <!-- 🆕 UPDATE WARNA TOMBOL JADWAL (COKELAT & BIRU) -->
        <!-- ========================================== -->
        <div style="margin-top: 40px; display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 20px;">
            
            <!-- Dua Tombol Berjejer Horizontal (Kiri) dengan Warna Baru -->
            <div style="display: flex; gap: 15px;">
                <!-- Jadwal Ruang: Warna Cokelat -->
            ...
            <!-- Tombol Logout Khusus di Pojok Kanan Paling Bawah -->
            <div>
    ...
    <?php else: ?>
        <!-- Tampilan Pesan Jika Bukan Admin yang Login -->
